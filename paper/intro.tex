...
3 Submissions \cite{nistpqc-round3} --- \textsc{Kyber} \cite{kyberoriginal} (standardized as ML-KEM), Saber \cite{AFRICACRYPT:DKRV18}, NTRU LPRime \cite{ntruprime}, and FrodoKEM \cite{takeofffrodo} --- are closely related lattice KEMs, spanning a
