...
sets alongside all standardized FrodoKEM-SHAKE and HQC parameter sets. All three \textsc{Kaiburr} variants, including kaiburr-6144, remain within the
...
FrodoKEM-SHAKE~\cite{frodoKEM-github}, and HQC~\cite{hqc-github,hqc2025spec}.
