...
We note that all variants of \tetsc{Kyber} fix $q=3329$, which is explicitly justified in the submission documentation to NIST. The modulus
...
in Jasmin~\cite{CCS:ABBBGL17} (see Section~\ref{implementation}). The standard deviation
