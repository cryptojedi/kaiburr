...
implementation-specific hardware advantage unrelated to the lattice-based KEM operations we are looking to compare.
...
The reference implementations are, on average, TBD percent slower for kaiburr C and TBD percent
