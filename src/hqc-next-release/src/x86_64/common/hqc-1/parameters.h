...
#define PARAM_N_MULT                18048       ///< Define the size (in 64-bit words) for PARAM_N as 256-bit elements
...
#define PARAM_GF_POLY               0x11B       ///< Generator polynomial of GF(2^PARAM_M) in hex
#define PARAM_GF_MUL_ORDER          255         ///< Size of multiplicative group of GF(2^PARAM_M) (2^PARAM_M–1)
...
#define RS_POLY_COEFS \
    74, 81, 224, 114, 221, 115, 110, 88, 91, 151, 139, 151, 84, 184, 21, 242, \
    97, 199, 87, 113, 104, 184, 197, 111, 89, 81, 156, 71, 128, 217, 1  ///< Coefficients of the Reed-Solomon generator polynomial
